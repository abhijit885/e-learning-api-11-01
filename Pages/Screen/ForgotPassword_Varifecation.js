...
const ForgotPassword_Varifecation = ({ navigation }) => {
    const [data, setData] = React.useState({
      ...
      const forgitpasswordverificationOTP = () => {
        alert(data.otp+data.email)
    ...
    return (
        ...
        <ScrollView showsVerticalScrollIndicator={false}>
            <View style={{ marginTop: 50, width: '100%', height: 70, justifyContent: 'center', alignItems: 'center' }}>
                <Text style={{ fontWeight: 'bo400ld', fontSize: 25, fontFamily: 'roboto-bold', }}>Forgot Password Verifecation</Text>
            ...
            <View style={styles.inputContainer}>
               ...
               // onPress={() => navigation.navigate('ForgotPasswordSubmit')}
                onPress={() => forgitpasswordverificationOTP()}
                >
...
export default ForgotPassword_Varifecation;
